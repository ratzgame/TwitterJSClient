...
function Twitter(config) {
	try {
        ...
        var twitterUrl =  config.twitterUrl ? config.twitterUrl : 'https://api.twitter.com';
		this.consumerKey = config.consumerKey;
		this.consumerSecret = config.consumerSecret;
		this.accessToken = config.accessToken;
		this.accessTokenSecret = config.accessTokenSecret;
		this.callBackUrl = config.callBackUrl;
		this.baseUrl = twitterUrl + '/1.1'; // appending version
		this.oauth = new OAuth(
            twitterUrl + '/oauth/request_token',
			twitterUrl + '/oauth/access_token',
			this.consumerKey,
			this.consumerSecret,
			'1.0',
			this.callBackUrl,
        ...
        console.log("Error: Could not config.");
    }
}
